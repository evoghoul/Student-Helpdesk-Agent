          ...
          {contextualActions.map((action, i) => {
            ...
            return (
              <button
                key={i}
                onClick={() => onSelectAction(action.query)}
                className="group flex shrink-0 items-center gap-1.5 rounded-full border border-slate-200 bg-white px-2.5 py-1 text-[11px] font-medium text-slate-700 hover:border-blue-300 hover:bg-blue-50/50 hover:text-blue-700 transition-all cursor-pointer shadow-2xs"
              >
