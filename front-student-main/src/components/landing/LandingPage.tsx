      ...
      >
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="relative hidden lg:block">
            <div className="rounded-3xl border border-slate-200 bg-white/95 p-5 shadow-2xl shadow-blue-900/10 backdrop-blur-sm">
              ...
              <div className="space-y-3 py-4 text-sm">
                ...
                <div className="w-fit max-w-[88%] rounded-2xl rounded-tl-sm border border-slate-200 bg-slate-50 px-4 py-2.5 text-slate-700">
                  {t.landingPreviewA ||
          ...
          <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {featureCards.map((f) => {
              ...
              return (
                <div
                  key={f.title}
                  className="rounded-3xl border border-slate-200/90 bg-white p-7 shadow-xs hover:border-blue-300 hover:shadow-md transition-all group"
                >
                  <div
