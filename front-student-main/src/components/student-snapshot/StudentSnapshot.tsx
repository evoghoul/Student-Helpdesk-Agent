  ...
  return (
    ...
    >
      <div className="flex flex-col flex-1">
        ...
        <div className="mt-1.5 flex h-5 items-center text-xs font-semibold text-slate-700 truncate">
          {meta}
        </div>

        {/* Subtext Line - Fixed height with ellipsis */}
        <p className="mt-0.5 h-7 text-[11px] leading-snug text-slate-500 line-clamp-1 truncate" title={typeof subtext === "string" ? subtext : undefined}>
          {subtext}
        </p>
      </div>
