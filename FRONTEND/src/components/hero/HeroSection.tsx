        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2 text-xs text-foreground">
              ...
              >
                ...
                <span className="font-semibold text-foreground">{CURRENT_STUDENT.name}</span>
                <span className="text-slate-400">â€¢</span>
                <span className="font-mono text-muted-foreground">{CURRENT_STUDENT.id}</span>
                <span className="text-slate-400">â€¢</span>
                <span className="text-muted-foreground">{CURRENT_STUDENT.programme}</span>
              </div>
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-sm">
              ...
              {/* Main Card Container */}
              <div className="relative rounded-2xl border border-blue-200/80 bg-card/95 p-6 shadow-xl shadow-blue-900/5 backdrop-blur-md">
                {/* Visual Header */}
                <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-muted-foreground">{t.autonomousContextEngine || "Autonomous Context Engine"}</p>
                    </div>
                  </div>
